...
return [
    ...
    'company' => [
        'ruc' => env('GREENTER_COMPANY_RUC', '10154316189'),
        'razonSocial' => env('GREENTER_COMPANY_NAME', 'GRUPOA&T SAC'),
        'nombreComercial' => env('GREENTER_COMPANY_COMMERCIAL_NAME', 'GRUPOA&T'),

        'address' => [
            'ubigeo' => env('GREENTER_COMPANY_UBIGEO', '150501'),
            'departamento' => env('GREENTER_COMPANY_DEPARTMENT', 'LIMA'),
            'provincia' => env('GREENTER_COMPANY_PROVINCE', 'Cañete'),
            'distrito' => env('GREENTER_COMPANY_DISTRICT', 'San Vicente'),
            'direccion' => env('GREENTER_COMPANY_ADDRESS', 'Urb. Libertad Mz. I Lt. 5 Calle las Moras S/N San Vicente - Cañete - Lima - Perú'),
        ],
    ...
    'report' => [
        'params' => [
            'system' => [
                'logo' => env('GREENTER_COMPANY_LOGO', public_path('img/logoAYT.png')),
                'hash' => '',
            ],
            'user' => [
                'header' => env('GREENTER_COMPANY_HEADER', 'Cel: <b>942784270</b>'),
                'extras' => [
